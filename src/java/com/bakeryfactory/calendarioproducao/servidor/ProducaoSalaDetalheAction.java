 ...
 * @date 15/01/2017
 */
public class ProducaoSalaDetalheAction implements Action {

    public ProducaoSalaDetalheAction() {
    }

    @Override
    public String getRequestName() {
        return "reuniaoSalaDetalheAction";
    }
    ...
    private Response load(Object inputPar, UserSessionParameters userSessionPars, HttpServletRequest request, HttpServletResponse response, HttpSession userSession, ServletContext context) {
        ...
        try {
            ...
            Criteria criteria = session.createCriteria(ProducaoSalaVO.class);
            criteria.add(Restrictions.eq("id", Integer.valueOf(pk)));

            ProducaoSalaVO producaoSala = (ProducaoSalaVO) criteria.uniqueResult();
    ...
    public Response insert(Object inputPar, UserSessionParameters userSessionPars, HttpServletRequest request, HttpServletResponse response, HttpSession userSession, ServletContext context) {
        ...
        try {
            Object[] pars = (Object[]) inputPar;
            ProducaoSalaVO producaoSala = (ProducaoSalaVO) pars[1];

            session = HibernateUtil.getSessionFactory().openSession();
            session.beginTransaction();

            session.save(producaoSala);
