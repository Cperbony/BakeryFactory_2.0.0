 ...
 * @date   15/01/2017
 */
public class AgendaCategoriaCompromissoGridAction implements Action {
    
    public AgendaCategoriaCompromissoGridAction() {
    }

    @Override
    public String getRequestName() {
        return "agendaCategoriaCompromissoGridAction";
    }
    ...
    private Response load(Object inputPar, UserSessionParameters userSessionPars, HttpServletRequest request, HttpServletResponse response, HttpSession userSession, ServletContext context) {
        ...
        GridParams pars = (GridParams) inputPar;
        String baseSQL = "select AGENDA_CATEGORIA_COMPROMISSO from com.bakeryfactory.calendarioproducao.java.AgendaCategoriaCompromissoVO as AGENDA_CATEGORIA_COMPROMISSO";
        try {
            ...
            Response res = HibernateUtils.getBlockFromQuery(
                    ...
                    com.bakeryfactory.calendarioproducao.java.AgendaCategoriaCompromissoVO.class,
                    baseSQL,
                    new Object[0],
                    new Type[0],
